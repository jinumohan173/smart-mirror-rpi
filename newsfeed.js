		...
		if (this.newsItems.length > 0) {
			...
			if (!this.config.showFullArticle && (this.config.showSourceTitle || this.config.showPublishDate)) {
				...
				if (this.config.showPublishDate) {
					sourceAndTimestamp.innerHTML += moment(new Date(this.newsItems[this.activeItem].pubdate)).fromNow(); //here you are editing
					//sourceAndTimestamp.innerHTML += moment(moment(this.newsItems[this.activeItem].pubdate,"YYYY-MM-DD HH:mm")).fromNow();
